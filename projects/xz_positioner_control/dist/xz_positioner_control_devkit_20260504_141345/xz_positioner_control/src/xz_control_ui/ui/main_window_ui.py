...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.runtimeLabel = QLabel(self.topbarFrame)
        self.runtimeLabel.setObjectName(u"runtimeLabel")

        self.topbarLayout.addWidget(self.runtimeLabel)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.runtimeLabel.setText(QCoreApplication.translate("MainWindow", u"Runtime: DEMO", None))
